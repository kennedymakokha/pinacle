            ...
            <div className="w-screen h-screen ">
                <div className="sm:bg-ws bg-sm-ws bg-no-repeat w-full h-full relative z-0">
                    ...
                    <div className="absolute top-0 left-0 right-0 flex flex-col justify-center items-center z-10">
                        <Navbar />
                        <div className=" absolute rounded-bl-[60px] rounded-tr-[60px] sm:top-[300px] top-[200px] sm:left-10  flex items-center justify-center sm:bg-red-100  sm:w-[800px] w-full h-96  -z-10">
